            ...
            <div className={`flex-1 p-6 transition-all duration-300 ${isCollapsed ? 'ml-20' : 'ml-64'}`}>
                <div className="flex-1 p-6">
                    ...
                    <p className="text-justify mt-2">
                        Gauss-Seidel iteration is an iterative method used to solve a system of linear equations. It is a variant of the Jacobi method that converges faster. The method is based on the fixed-point iteration formula:
                    </p>
